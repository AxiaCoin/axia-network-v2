...
axia_path="$build_dir/axgo"
plugin_dir="$build_dir/plugins"
evm_path="$plugin_dir/evm"

# Avalabs docker hub
# axiasystem/axia - defaults to local as to avoid unintentional pushes
# You should probably set it - export DOCKER_REPO='axiasystem/axgo'
axia_dockerhub_repo=${DOCKER_REPO:-"axgo"}
