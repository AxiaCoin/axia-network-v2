...
AVALANCHE_REMOTE="git@github.com:ava-labs/axia.git"
...
AVALANCHE_CLONE="$WORKPREFIX/axia"
...
AVALANCHE_COMMIT_HASH="$(git -C "$EXISTING_GOPATH/$AVA_LABS_RELATIVE_PATH/axia" rev-parse --short HEAD)"
