...
func TestRevokeToken(t *testing.T) {
	...
	// Make a token
	endpoints := []string{"/ext/info", "/ext/bc/S", "/ext/metrics"}
	tokenStr, err := auth.NewToken(testPassword, defaultTokenLifespan, endpoints)
	assert.NoError(t, err)
...
func TestWrapHandlerUnauthorizedEndpoint(t *testing.T) {
	...
	unauthorizedEndpoints := []string{"/ext/bc/S", "/ext/metrics", "", "/foo", "/ext/info/foo"}
...
func TestWrapHandlerAuthEndpoint(t *testing.T) {
	...
	// Make a token
	endpoints := []string{"/ext/info", "/ext/bc/S", "/ext/metrics", "", "/foo", "/ext/info/foo"}
	tokenStr, err := auth.NewToken(testPassword, defaultTokenLifespan, endpoints)
	assert.NoError(t, err)
...
func TestWrapHandlerAccessAll(t *testing.T) {
	...
	endpoints := []string{"/ext/info", "/ext/bc/S", "/ext/metrics", "", "/foo", "/ext/foo/info"}
