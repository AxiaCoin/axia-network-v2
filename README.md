...
Node implementation for the [Axia](https://avax.network) network -
...
```sh
sudo su -
wget -O - https://downloads.avax.network/axia.gpg.key | apt-key add -
echo "deb https://downloads.avax.network/apt bionic main" > /etc/apt/sources.list.d/axia.list
exit
```
...
sudo su -
wget -O - https://downloads.avax.network/axia.gpg.key | apt-key add -
echo "deb https://downloads.avax.network/apt focal main" > /etc/apt/sources.list.d/axia.list
exit
```
...
A node will not [report healthy](https://docs.avax.network/build/axia-apis/health) until it is done bootstrapping.
