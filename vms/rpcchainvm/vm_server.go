...
import (
	...
	"github.com/axiacoin/axia-network-v2/api/keystore/gkeystore"
	"github.com/axiacoin/axia-network-v2/api/metrics"
	"github.com/axiacoin/axia-network-v2/chains/atomic/gsharedmemory"
	"github.com/axiacoin/axia-network-v2/database/corruptabledb"
	"github.com/axiacoin/axia-network-v2/database/manager"
	"github.com/axiacoin/axia-network-v2/database/rpcdb"
	...
	appsenderpb "github.com/axiacoin/axia-network-v2/proto/pb/appsender"
	httppb "github.com/axiacoin/axia-network-v2/proto/pb/http"
	keystorepb "github.com/axiacoin/axia-network-v2/proto/pb/keystore"
...
func (vm *VMServer) Initialize(_ context.Context, req *vmpb.InitializeRequest) (*vmpb.InitializeResponse, error) {
	...
	swapChainID, err := ids.ToID(req.SwapChainId)
	if err != nil {
		return nil, err
	}
