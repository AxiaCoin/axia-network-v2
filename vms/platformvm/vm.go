...
const (
	...
	// Maximum future start time for staking/nominating
...
func (vm *VM) CreateHandlers() (map[string]*common.HTTPHandler, error) {
	...
	if err := server.RegisterService(&Service{vm: vm}, "core"); err != nil {
		return nil, err
	}
...
func (vm *VM) CreateStaticHandlers() (map[string]*common.HTTPHandler, error) {
	...
	server.RegisterCodec(json.NewCodec(), "application/json")
	server.RegisterCodec(json.NewCodec(), "application/json;charset=UTF-8")
	if err := server.RegisterService(&StaticService{}, "core"); err != nil {
		return nil, err
	}
...
func (vm *VM) GetValidatorSet(height uint64, allychainID ids.ID) (map[ids.ShortID]uint64, error) {
