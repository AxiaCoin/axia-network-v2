...
func setupWS(t *testing.T, isAXCAsset bool) ([]byte, *VM, *AxiaWalletService, *atomic.Memory, *Tx) {
...
// 3) The axiawallet service that wraps the VM
// 4) atomic memory to use in tests
func setupWSWithKeys(t *testing.T, isAXCAsset bool) ([]byte, *VM, *AxiaWalletService, *atomic.Memory, *Tx) {
