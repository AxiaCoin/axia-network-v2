...
var (
	...
	errPChainHeightNotMonotonic = errors.New("non monotonically increasing Core-chain height")
	errPChainHeightNotReached   = errors.New("block Core-chain height larger than current Core-chain height")
	...
	errPChainHeightTooLow       = errors.New("block Core-chain height is too low")
)
...
// 2) [child]'s Core-Chain height >= [parentPChainHeight]
...
// 6) [childPChainHeight] <= the current Core-Chain height
