...
var (
	...
	errCoreChainHeightNotMonotonic = errors.New("non monotonically increasing Corechain height")
	errCoreChainHeightNotReached   = errors.New("block Corechain height larger than current Corechain height")
	...
	errCoreChainHeightTooLow       = errors.New("block Corechain height is too low")
)
...
// 2) [child]'s CoreChain height >= [parentCoreChainHeight]
...
// 6) [childCoreChainHeight] <= the current CoreChain height
