...
- `PChainHeight` the height of the last accepted block on the Core-chain at the time the block is produced.
...
- A block must have a `PChainHeight` that is less or equal to current Core-Chain height.
