...
axia_testing_repo="axiasystem/axia-testing"
axia_byzantine_repo="axiasystem/axia-byzantine"

# Define axia-testing and axia-byzantine versions to use
axia_testing_image="axiasystem/axia-testing:master"
axia_byzantine_image="axiasystem/axia-byzantine:update-axia-v1.7.0"
