...
func TestValidateConfig(t *testing.T) {
	tests := map[string]struct {
		...
		"empty AX-Chain genesis": {
			networkID: 12345,
			config: func() *Config {
				thisConfig := LocalConfig
				thisConfig.AXChainGenesis = ""
				return &thisConfig
			}(),
			err: "AX-Chain genesis cannot be empty",
		},
		"empty message": {
			networkID: 12345,
			config: func() *Config {
...
var (
	customGenesisConfigJSON = `{
		...
		"allocations": [
			...
			{
				"ethAddr": "0xb3d82b1367d362de99ab59a658165aff520cbd4d",
				"axcAddr": "X-local18jma8ppw3nhx5r4ap8clazz0dps7rv5u00z96u",
			...
			{
				"ethAddr": "0xb3d82b1367d362de99ab59a658165aff520cbd4d",
				"axcAddr": "X-local1ur873jhz9qnaqv5qthk5sn3e8nj3e0kmggalnu",
