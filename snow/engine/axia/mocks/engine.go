...
import (
	consensusaxia "github.com/axiacoin/axia-network-v2/snow/consensus/axia"
...
func (_m *Engine) GetVtx(vtxID ids.ID) (consensusaxia.Vertex, error) {
	ret := _m.Called(vtxID)

	var r0 consensusaxia.Vertex
	if rf, ok := ret.Get(0).(func(ids.ID) consensusaxia.Vertex); ok {
		r0 = rf(vtxID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(consensusaxia.Vertex)
		}
	}
