...
func setup(t *testing.T) (ids.ShortID, validators.Set, *common.SenderTest, *block.TestVM, *Transitive, kleroterion.Block) {
	...
	gBlk := &kleroterion.TestBlock{TestDecidable: choices.TestDecidable{
		IDV:     Genesis,
	...
	vm.GetBlockF = func(blkID ids.ID) (kleroterion.Block, error) {
		switch blkID {
		case gBlk.ID():
			return gBlk, nil
		default:
...
func TestEngineAdd(t *testing.T) {
	...
	parent := &kleroterion.TestBlock{TestDecidable: choices.TestDecidable{
		IDV:     ids.GenerateTestID(),
		StatusV: choices.Unknown,
	}}
	blk := &kleroterion.TestBlock{
	...
	vm.ParseBlockF = func(b []byte) (kleroterion.Block, error) {
	...
	vm.ParseBlockF = func(b []byte) (kleroterion.Block, error) { return nil, errUnknownBytes }
...
func TestEngineMultipleQuery(t *testing.T) {
	...
	vm.GetBlockF = func(id ids.ID) (kleroterion.Block, error) {
		switch id {
		case gBlk.ID():
			return gBlk, nil
		case blk0.ID():
...
func TestEngineBuildBlock(t *testing.T) {
	...
	vm.BuildBlockF = func() (kleroterion.Block, error) { return blk, nil }
...
func TestEngineBlockingChitRequest(t *testing.T) {
	...
	missingBlk := &kleroterion.TestBlock{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Unknown,
		},
	...
	parentBlk := &kleroterion.TestBlock{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
	...
	blockingBlk := &kleroterion.TestBlock{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
...
func TestEngineBlockingChitResponse(t *testing.T) {
	...
	issuedBlk := &kleroterion.TestBlock{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
...
func TestEngineUndeclaredDependencyDeadlock(t *testing.T) {
	...
	validBlk := &kleroterion.TestBlock{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
	...
	invalidBlk := &kleroterion.TestBlock{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
...
func TestEngineInvalidBlockIgnoredFromUnexpectedPeer(t *testing.T) {
	...
	pendingBlk := &kleroterion.TestBlock{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
...
func TestEngineBuildBlockLimit(t *testing.T) {
	...
	blks := []kleroterion.Block{blk0, blk1}
	...
	blkToReturn := 0
	vm.BuildBlockF = func() (kleroterion.Block, error) {
...
func TestEngineReceiveNewRejectedBlock(t *testing.T) {
	...
	acceptedBlk := &kleroterion.TestBlock{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
	...
	rejectedBlk := &kleroterion.TestBlock{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Unknown,
		},
...
func TestEngineNonPreferredAmplification(t *testing.T) {
	...
	preferredBlk := &kleroterion.TestBlock{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
	...
	nonPreferredBlk := &kleroterion.TestBlock{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
