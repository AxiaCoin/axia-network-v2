...
type TestVM struct {
	...
	BuildBlockF    func() (kleroterion.Block, error)
	ParseBlockF    func([]byte) (kleroterion.Block, error)
...
func (vm *TestVM) BuildBlock() (kleroterion.Block, error) {
...
func (vm *TestVM) ParseBlock(b []byte) (kleroterion.Block, error) {
...
func (vm *TestVM) GetBlock(id ids.ID) (kleroterion.Block, error) {
	if vm.GetBlockF != nil {
