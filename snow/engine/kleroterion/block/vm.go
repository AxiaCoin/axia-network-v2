...
// ChainVM defines the required functionality of a Kleroterion VM.
//
// A Kleroterion VM is responsible for defining the representation of state,
...
type ChainVM interface {
	...
	// returned.
	BuildBlock() (kleroterion.Block, error)
...
type Getter interface {
	...
	GetBlock(ids.ID) (kleroterion.Block, error)
}
...
type Parser interface {
	...
	// bytes.
	ParseBlock([]byte) (kleroterion.Block, error)
}
