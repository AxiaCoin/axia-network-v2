...
import (
	consensuskleroterion "github.com/axiacoin/axia-network-v2/snow/consensus/kleroterion"
...
func (_m *Engine) GetBlock(_a0 ids.ID) (consensuskleroterion.Block, error) {
	ret := _m.Called(_a0)

	var r0 consensuskleroterion.Block
	if rf, ok := ret.Get(0).(func(ids.ID) consensuskleroterion.Block); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(consensuskleroterion.Block)
		}
	}
