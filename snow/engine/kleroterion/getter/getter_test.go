...
func TestAcceptedFrontier(t *testing.T) {
	...
	dummyBlk := &kleroterion.TestBlock{
	...
	vm.GetBlockF = func(bID ids.ID) (kleroterion.Block, error) {
...
func TestFilterAccepted(t *testing.T) {
	...
	blk0 := &kleroterion.TestBlock{TestDecidable: choices.TestDecidable{
		IDV:     blkID0,
		StatusV: choices.Accepted,
	}}
	blk1 := &kleroterion.TestBlock{TestDecidable: choices.TestDecidable{
		IDV:     blkID1,
		StatusV: choices.Accepted,
	}}
