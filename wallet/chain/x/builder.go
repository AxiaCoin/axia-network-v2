...
func (b *builder) NewBaseTx(
	...
	axc.SortTransferableOutputs(outputs, Parser.Codec()) // sort the outputs

	return &txs.BaseTx{BaseTx: axc.BaseTx{
...
func (b *builder) NewImportTx(
	...
	axc.SortTransferableOutputs(outputs, Parser.Codec())
	return &txs.ImportTx{
		BaseTx: txs.BaseTx{BaseTx: axc.BaseTx{
			NetworkID:    b.backend.NetworkID(),
			BlockchainID: b.backend.BlockchainID(),
...
func (b *builder) spend(
	...
	axc.SortTransferableOutputs(outputs, Parser.Codec()) // sort the change outputs
